...
*/
console.log("Task: A");console.log("Task: A");
...
console.log('Raspberry is at position:', raspberryPosition);
...
console.log(findFruitPosition(fruits, 'raspberry'));
...
for (let i = 0; i < fruits.length; i++) {
    if (fruits[i][0] === 'b' || fruits[i][0] === 'B') {
        fruitsWithB.push(fruits[i]);
    }
}

console.log(fruitsWithB.length);
